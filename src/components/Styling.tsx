...
export function Header(props: HeaderProps) {
	return (
		<div className={`${props.className} font-Roboto text-base font-bold`}>
			{props.content}
		</div>
	);
}
...
export function Info(props: InfoProps) {
	...
	return (
		<div>
			<Header className={props.headerClass} content={props.header} />
			<div
				className={`${props.contentClass} font-Roboto text-xs`}
